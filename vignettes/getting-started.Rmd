...
This is a simple getting started guide that show the basic operations `tsic` can perform in a straight-forward way.
...
daily_grid <- compute_daily_grid(agg_interpreter, tauc = lb_med_ub$aoc, 
                                 range_start = range_start-0.5, range_end = range_end+0.5)
str(daily_grid)
```
