...
test_that('scenario_recognizer recognizes scenarios', {
  ...
  expect_equal(recognize_scenario(ihist = f_ihist_s1), 'Scenario 1')
  expect_equal(recognize_scenario(ihist = f_ihist_s2), 'Scenario 2')
  expect_equal(recognize_scenario(ihist = f_ihist_s3), 'Scenario 3')
  expect_equal(recognize_scenario(ihist = f_ihist_s4), 'Scenario 4')
  expect_equal(recognize_scenario(ihist = f_ihist_s5), 'Scenario 5')

  expect_equal(recognize_scenario(ihist = m_ihist_s1), 'Scenario 1')
  expect_equal(recognize_scenario(ihist = m_ihist_s2), 'Scenario 2')
  expect_equal(recognize_scenario(ihist = m_ihist_s3), 'Scenario 3')
  expect_equal(recognize_scenario(ihist = m_ihist_s4), 'Scenario 4')
  expect_equal(recognize_scenario(ihist = m_ihist_s5), 'Scenario 5')
})
